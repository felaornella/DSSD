...
for (let i=1; i<=count_soc;i++){
    ...
    $("#buttonCradoCarpetaFisca"+i).on("click",generarCarpetaFisca)
}
...
function generarCarpetaFisca(){
  solicitudId= $(this).data('idsol')
  Swal.fire({
    title: 'La carpeta fisica esta lista?',
    icon: 'warning',
    showCancelButton: true,
    confirmButtonColor: '#3085d6',
    cancelButtonColor: '#d33',
